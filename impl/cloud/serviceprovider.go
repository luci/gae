...
type ServiceProvider interface {
	...
	// AccessToken generates an access token for the specified scopes belonging
	// to the current system service.
	AccessToken(c context.Context, scopes ...string) (*oauth2.Token, error)
...
func (notImplementedServiceProvider) AccessToken(c context.Context, scopes ...string) (*oauth2.Token, error) {
	return nil, ErrNotImplemented
}
