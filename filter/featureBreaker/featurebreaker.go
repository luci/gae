...
type FeatureBreaker interface {
	...
	// synchronization if necessary.
	//
	// You may use a callback returned by FlakyErrors to emulate randomly
	// occurring errors.
	//
...
// useDefaultErr is never returned but used as an indicator to use defaultError.
var useDefaultErr = errors.New("use default error")
